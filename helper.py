...
def data_over_time(df, col):
    # Count occurrences of each year and column combination
...
def most_successful(df, sport):
    # Drop rows with NaN in 'Medal' column
    ...
    x = medal_counts.head(15).merge(df, on='Name', how='left')[['Name', 'Medals', 'Sport', 'region']].drop_duplicates(
        'Name')
...
def country_event_heatmap(df,country):
    ...
    print(pt,"this is country wise data")
    return pt
